...
#include "CustomAbilityTagRelationship.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FAbilityTagRelationshipInfo
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class CUSTOMGAMEPLAYSYSTEM_API UCustomAbilityTagRelationship : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FAbilityTagRelationshipInfo> AbilityTagRelationships;
};
