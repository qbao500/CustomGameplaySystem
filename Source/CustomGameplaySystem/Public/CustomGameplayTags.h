...
namespace CustomTags
{
	...
	// UI tags
	CUSTOMGAMEPLAYSYSTEM_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI);
	CUSTOMGAMEPLAYSYSTEM_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer);
	CUSTOMGAMEPLAYSYSTEM_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_Game);
	CUSTOMGAMEPLAYSYSTEM_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_GameMenu);
	CUSTOMGAMEPLAYSYSTEM_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_Menu);
	CUSTOMGAMEPLAYSYSTEM_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_Modal);
