...
#include "RotationLibrary.generated.h"

/**
 * 
 */
UCLASS()
class CUSTOMGAMEPLAYLIBRARY_API URotationLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category="BlueprintRotationLibrary")
	static FRotator RotInterpByQuat(const FRotator& Current, const FRotator& Target, const float DelaTime, const float InterpSpeed);
};
